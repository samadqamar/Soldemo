   ...
   // public PhotonView view;
    ...
    public void SwitchCharacterSettings(string name)
    {
        ...
        if(name == "Male")
        {
            ...
            Debug.Log( "male aaaaaaaaaaaaaaa" );
        ...
        if (name == "Female")
        {
            ...
            Debug.Log( "female aaaaaaaaaaaaaaa" );
        }
    }
    private void Start()
    {
    ...
    private void Update()
    {
       ...
       /* for (int i = 0; i < arrays.Length; i++)
        ...
        if (Input.GetKeyDown( KeyCode.P ))
        {
            ...
            view.RPC( "SetArrayRPC", RpcTarget.All, (object)arrays );
        }*/
    }
   /* [PunRPC]
    private void SetArrayRPC( float[] array )
    {
       // arrays = array;
        arraytxt.text = array[0].ToString();
